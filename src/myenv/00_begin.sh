...
export MYENV_TOOL_VERSION_SUBCMD_SRC_PATH=${MYENV_TOOL_VERSION_DIR}/subcmd/src
export MYENV_TOOL_VERSION_SUBCMD_EXE_PATH=${MYENV_TOOL_VERSION_DIR}/subcmd/bin

export MYENV_TOOL_SH_VERSION_DIR=${MYENV_TOOL_SRC_PATH}/mysh/v${MYENV_TOOL_VERSION}
export MYENV_TOOL_SH_VERSION_SUBCMD_SRC_PATH=${MYENV_TOOL_SH_VERSION_DIR}/subcmd/src
export MYENV_TOOL_SH_VERSION_SUBCMD_EXE_PATH=${MYENV_TOOL_SH_VERSION_DIR}/subcmd/bin
