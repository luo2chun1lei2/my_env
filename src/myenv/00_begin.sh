...
export MYENV_TOOL_SH_VERSION_SUBCMD_SRC_PATH=${MYENV_TOOL_SH_VERSION_DIR}/subcmd_src
export MYENV_TOOL_SH_VERSION_SUBCMD_EXE_PATH=${MYENV_TOOL_SH_VERSION_DIR}/subcmd_exe
